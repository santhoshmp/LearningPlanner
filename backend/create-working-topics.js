...
async function createWorkingTopics() {
  ...
  try {
    ...
    // Create additional topics with all required fields
    ...
    for (const topicData of additionalTopics) {
      try {
        ...
        // Create the topic with all required fields
        const topic = await prisma.topic.create({
          data: {
            name: topicData.name,
            displayName: topicData.name, // Add the required displayName field
